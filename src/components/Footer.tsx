...
// 1. Contrats de données TypeScript
export interface FooterLink {
  label: string;
  href: string;
}
...
// 2. Mock des données
const MOCK_FOOTER_DATA: FooterData = {
  description: "Expert en dératisation, désinsectisation et désinfection à Yaoundé et Douala. Intervention rapide, garantie 6 mois et solutions éco-responsables.",
  navigation: [
    { label: 'Accueil', href: '#home' },
    { label: 'À propos', href: '#about' },
    { label: 'Services', href: '#services' },
  ...
  services: [
    ...
    { label: 'Prévention & Suivi', href: '#services' },
  ],
  contact: {
    address: "Yaoundé & Douala",
    cityCountry: "Cameroun",
    phone: "+237690372977",
    phoneDisplay: "+237 690 37 29 77",
    email: "contact@nexora.cm"
  }
};
    ...
    <footer className="bg-zinc-950 bg-white dark:bg-zinc-950 border-t  dark:border-zinc-200 pt-16 pb-8 md:pt-24 md:pb-12 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-zinc-900 dark:border-zinc-200/80 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] md:text-xs font-medium text-zinc-500 dark:text-zinc-400">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 font-mono text-[10px] text-center md:text-right select-none">
            Des espaces sains, protégés et durables.
          </p>
        </div>
