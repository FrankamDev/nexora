  ...
  items: [
    {
      ...
      text: "Nous avions une infestation de cafards très gênante. NEXORA est intervenu rapidement, discrètement et efficacement. Depuis plus de 5 mois, plus aucun problème. Je recommande vivement !"
    },
    {
      id: "testi-2",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop",
      ...
      company: "Résidence Les Cocotiers",
      text: "Des rats dans notre immeuble nous posaient de gros soucis. L’équipe NEXORA a été professionnelle, claire sur les traitements et a respecté la garantie. Résultat impeccable."
    },
    {
      id: "testi-3",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop",
      ...
      text: "Pour un cabinet médical, l’hygiène est primordiale. NEXORA a réalisé une désinfection complète et un traitement préventif. Service sérieux, rapide et rassurant."
    }
  ]
};
    ...
    <section id="testimonials" className="relative py-16 md:py-28overflow-hidden dark:bg-zinc-950 bg-white transition-colors duration-500 overflow-hidden border-b border-zinc-900 dark:border-zinc-200">
      ...
      <div className="relative z-10 max-w-7xl mx-auto  px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto min-h-[360px] sm:min-h-[280px] md:min-h-[260px] flex items-center">
          ...
          {/* FLÈCHES DE NAVIGATION STRUCTURELLES */}
          <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 md:translate-x-0 md:bottom-auto md:left-[-24px] md:right-[-24px] md:top-1/2 md:-translate-y-1/2 flex md:justify-between gap-4 z-20">
            <button
              onClick={prevSlide}
              aria-label="Avis précédent"
