...
// 1. Contrat de données TypeScript
...
const MOCK_CTA_DATA: CTAData = {
  titleLight: "Prêt à retrouver un espace ",
  titleGradient: "sain ?",
  description: "Rats, cafards, moustiques ou besoin de désinfection ? Nous intervenons rapidement à Yaoundé et Douala avec garantie de résultat.",
