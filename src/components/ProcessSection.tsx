...
const MOCK_PROCESS_DATA: ProcessData = {
  ...
  titleHighlight: "efficace",
  titleEnd: " et transparent.",
  description: "Nous suivons une méthodologie éprouvée en 4 étapes pour garantir l’élimination durable des nuisibles et votre entière satisfaction.",
  ...
  steps: [
    {
      ...
      desc: "Nous analysons votre situation, identifions les nuisibles et les zones à risque pour proposer le traitement le plus adapté.",
    },
    {
      number: 2,
      iconType: "solution",
      title: "Proposition de traitement",
      desc: "Vous recevez un devis clair et transparent avec la méthode recommandée, les produits utilisés et le délai d’intervention.",
    },
    {
      number: 3,
      iconType: "build",
      title: "Intervention professionnelle",
      desc: "Nos techniciens interviennent rapidement avec des produits certifiés, en respectant votre environnement et votre sécurité.",
    },
    {
      number: 4,
      iconType: "optimize",
      title: "Suivi & Garantie",
      desc: "Nous assurons un suivi après traitement et vous offrons une garantie jusqu’à 6 mois. Si le problème revient, nous revenons gratuitement.",
    },
  ],
};
