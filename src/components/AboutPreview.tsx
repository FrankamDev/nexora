...
// Mock Data
const MOCK_ABOUT_DATA: AboutData = {
  badgeLabel: "L'ADN de NEXORA",
  titleLight: "Nous protégeons vos ",
  titleGradient: "espaces de vie",
  titleEnd: ".",
  description:
    "Spécialistes de la dératisation, désinsectisation et désinfection à Yaoundé et Douala. Nous intervenons rapidement pour rendre vos locaux sains, sûrs et durables.",
  pillars: [
    {
      id: "pillar-1",
      title: "Notre Mission",
      tagline: "Éliminer les nuisibles, protéger durablement",
      iconType: "mission",
      desc: "Nous intervenons rapidement et efficacement contre les rats, cafards, moustiques et autres nuisibles. Notre objectif : vous offrir des espaces sains avec des solutions professionnelles et éco-responsables.",
      details: [
        "Intervention d'urgence sous 2 heures",
        "Traitements ciblés et respectueux de l'environnement",
        "Garantie de résultat jusqu'à 6 mois",
      ],
    },
    {
      id: "pillar-2",
      title: "Notre Vision",
      tagline: "Des environnements sains pour tous",
      iconType: "vision",
      desc: "Nous aspirons à un Cameroun où particuliers et entreprises vivent et travaillent dans des espaces totalement protégés des nuisibles, grâce à des méthodes modernes, efficaces et responsables.",
      details: [
        "Prévention proactive et suivi régulier",
        "Produits certifiés et à faible impact",
        "Couverture complète Yaoundé & Douala",
      ],
    },
  ],
};
...
export default function AboutPreview() {
  ...
  return (
    <section
      id="about"
      className="relative py-16 md:py-28 bg-zinc-50 dark:bg-zinc-950 border-y border-zinc-200 dark:border-zinc-900 overflow-hidden transition-colors duration-500"
    >
      {/* Background Subtil */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(#d4d4d8_0.8px,transparent_1px)] dark:bg-[radial-gradient(#27272a_0.8px,transparent_1px)] [background-size:24px_24px] md:[background-size:28px_28px] opacity-40" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center order-first lg:order-none">
            <div className="relative w-full max-w-sm sm:max-w-md">
              <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-xl shadow-zinc-200/50 dark:shadow-none flex flex-col">
                <div className="flex justify-between items-center mb-6 md:mb-8">
                  <div className="font-mono text-[9px] md:text-xs tracking-widest text-zinc-400 dark:text-zinc-500 font-bold">
                    PROTÉCTION MAP
                  </div>
                  <div className="flex items-center gap-1.5">
                    <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse" />
                    <span className="text-[10px] md:text-xs text-emerald-500 font-bold tracking-wider">
                      LIVE
                    </span>
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col justify-center gap-6 md:gap-8 relative py-4">
                  {/* Layer 1 */}
                  <div className="group relative bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 transition-colors hover:border-emerald-500/50">
                    <div className="absolute -top-2.5 left-4 px-2 py-0.5 bg-white dark:bg-zinc-900 text-[8px] font-mono tracking-widest text-zinc-400 dark:text-zinc-500 rounded border border-zinc-100 dark:border-zinc-800">
                      PRÉVENTION
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-500 shrink-0">
                ...
                <div className="text-center text-[9px] font-mono text-zinc-400 dark:text-zinc-500 mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800/60 select-none">
                  ÉRADICATION TOTALE • SUIVI CONTINU
                </div>
              </div>
            </div>
          </div>
